...
export default function Home() {
  ...
  <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
    <div className="text-xl md:text-2xl font-black tracking-tight text-gray-900 shrink-0">
    ...
    <a href="tel:+905550833001" className="bg-[#3b82f6] text-white px-4 py-2 md:px-6 md:py-2.5 rounded-lg font-bold text-sm md:text-base transition-all shadow-md">
      Tıkla Ara
    </a>
  </div>
</header>
  ...
  <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
    <div className="max-w-3xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <a href="tel:+905550833001" className="bg-[#3b82f6] text-white px-8 py-4 rounded-xl font-black text-center text-lg transition-all shadow-xl active:scale-95">
          HEMEN ARA
        </a>
        <div className="flex items-center justify-center gap-3 px-6 py-4 bg-white/10 border border-white/20 rounded-xl backdrop-blur-md text-white">
          <div className="w-2.5 h-2.5 bg-green-400 rounded-full animate-pulse shadow-[0_0_10px_rgba(74,222,128,0.8)]"></div>
          <span className="text-sm font-bold">Şu an müsaitiz</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <footer className="py-12 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-10">
            <div className="text-2xl font-black text-gray-900">OSMANLI<span className="text-[#3b82f6]">TESİSAT</span></div>
