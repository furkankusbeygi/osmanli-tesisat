...
export default function Home() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans selection:bg-[#3b82f6] selection:text-white">
      ...
      {/* HEADER VE LOGO KISMI (Burger Menü Dahil) */}
      ...
      {/* 4. HİZMETLERİMİZ - GÖRSELLİ VE POPUP'LI YENİ YAPI */}
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full relative z-10 overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8">
              ...
              <div className="flex gap-4">
                ...
                <button 
                  onClick={() => setSeciliHizmet(null)}
                  className="flex-1 bg-gray-100 text-gray-900 py-4 rounded-xl font-black hover:bg-gray-200 transition-colors"
                >
                  Kapat
                </button>
              </div>
