...
import Script from 'next/script'; // <--- BU IMPORT ŞART
...
export default function Home() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans selection:bg-[#3b82f6] selection:text-white">
      ...
      {/* GA4 TAKİP KODU BURAYA GELDİ - SİTEYİ BOZMAZ, ARKA PLANDA ÇALIŞIR */}
      <Script 
      ...
      <header className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
             <a href="tel:+905550833001" className="hidden md:flex items-center gap-2 bg-[#FFD700] text-gray-900 px-4 py-2 md:px-6 md:py-2.5 rounded-lg font-bold transition-all shadow-[0_0_15px_rgba(255,215,0,0.5)]">Tıkla Ara</a>
      ...
      {/* ... Hero, Hizmetler ve Footer aynı şekilde devam edecek ... */}
      {/* Buraya geri kalan kodlarını yapıştırmıştın, onlar kalsın. Ben sadece GA4'ü ekledim. */}
      
      {/* Sitenin geri kalanı buraya gelecek... */}
      <WhatsAppButton />
    </div>
  );
}